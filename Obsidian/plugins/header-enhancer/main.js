...
function applyYamlConfig(config, editor) {
...
var EditorHandlers = class {
        ...
        import_view.keymap.of([
          {
            ...
            run: (view) => {
              ...
              if (!isHeader(currentLine.text) || this.plugin.settings.autoNumberingMode === "off" /* OFF */) {
                return false;
              }
  ...
  async handlePressEnter(view) {
    ...
    if (!isHeader(currentLine.text) || this.plugin.settings.autoNumberingMode !== "on" /* ON */) {
      return false;
    }
    ...
    this.ribbonIconEl = this.addRibbonIcon(
      ...
      async (_evt) => {
        ...
        if (newState) {
          ...
          new import_obsidian6.Notice(i18n2.t("notices.autoNumberingEnabledForDocument"));
        } else {
          await this.handleRemoveHeaderNumber(activeView);
          new import_obsidian6.Notice(i18n2.t("notices.autoNumberingDisabledForDocument"));
        }
